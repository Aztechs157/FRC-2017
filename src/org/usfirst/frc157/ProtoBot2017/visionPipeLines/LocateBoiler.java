...
* @author GRIP
*/
public class LocateBoiler implements VisionPipeline, TargetList {
	...
	@Override	public void process(Mat source0) {
		...
		synchronized(filterContoursOutput)
		{
	...
	public ArrayList<MatOfPoint> getTargets() {
		...
		synchronized(filterContoursOutput)
		{
			filterContoursOutput.forEach(element -> result.add(element));		
		}
		return result;
	}
	...
	public boolean targetAvailable() {
		...
		synchronized(filterContoursOutput)
		{
			noTarget = filterContoursOutput.isEmpty();			
		}
		return (!noTarget);
	}
