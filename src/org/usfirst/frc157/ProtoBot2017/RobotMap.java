...
public class RobotMap {
    ...
    public static void init() {
        ...
        gearMotor = new CANTalon(12);
        LiveWindow.addActuator("Gear", "gearMotor", gearMotor);
        
        collectMotor = new CANTalon(13);
        LiveWindow.addActuator("Collect", "collectMotor", collectMotor);
        
        helixMotorRight = new CANTalon(9);
        helixMotorLeft = new CANTalon(8);
        shootMotor = new CANTalon(11); 
        climbMotor = new CANTalon(10); 
        rightGateRelay = new Relay(0);
        leftGateRelay = new Relay(1);
