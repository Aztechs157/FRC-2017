...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1 = new JoystickButton(driver, 1);
        joystickButton1.whenPressed(new AlignToField());

        joystickButton2 = new JoystickButton(driver, 2);
        joystickButton2.whenPressed(new SetCameraTarget());

        joystickButton3 = new JoystickButton(driver, 3);
        joystickButton3.whenPressed(new SetCamera());
