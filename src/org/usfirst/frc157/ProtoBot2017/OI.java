...
public class OI {
    ...
    public OI() {
        ...
        operatorButton3 = new  JoystickButton(operatorJoystick, 4);
        operatorButton3.whenPressed(new HelixCommand(Helix.helixCommand.LOADRIGHT));
        operatorButton5 = new  JoystickButton(operatorJoystick, 6);
        operatorButton5.whenPressed(new HelixCommand(Helix.helixCommand.IDLERIGHT));
